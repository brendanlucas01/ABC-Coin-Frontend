<p align="center">
  <a href="" rel="noopener">
 <img width=450px height=200px src="https://savjee.github.io/abc-coin-frontend/assets/img/github-project-logo.png" alt="Project logo"></a>
</p>
...
<div align="center">
  ...
  [![Build Status](https://travis-ci.org/Savjee/abc-coin-frontend.svg?branch=master)](https://travis-ci.org/Savjee/abc-coin-frontend)
  [![GitHub Issues](https://img.shields.io/github/issues/Savjee/abc-coin-frontend.svg)](https://github.com/Savjee/bearclaw/issues)
  [![GitHub Pull Requests](https://img.shields.io/github/issues-pr/Savjee/abc-coin-frontend.svg)](https://github.com/Savjee/bearclaw/pulls)
...
## 👀 Live demo
**[Check it out here.](https://savjee.github.io/abc-coin-frontend/)** You can create transactions, mine blocks and explore your own blockchain.

## 🏁 Getting Started <a name = "getting_started"></a>
Get a copy of the SavjeeCoin front-end running on your local machine (for playing around, testing or development).

```
git clone https://github.com/Savjee/abc-coin-frontend.git
```

Install the dependencies:
```
cd abc-coin-frontend
npm install
```
...
![](https://savjee.github.io/abc-coin-frontend/assets/screenshots/blockchain-overview.png)
...
![](https://savjee.github.io/abc-coin-frontend/assets/screenshots/create-new-transactions.png)
...
![](https://savjee.github.io/abc-coin-frontend/assets/screenshots/pending-transactions.png)
...
![](https://savjee.github.io/abc-coin-frontend/assets/screenshots/wallet-details.png)
